...
// ==============================================================
template <uint32_t B>
inline void accumulate_one_block(const uint8_t *codes, const uint8_t *LUT,
                                 uint16_t *result) {
...
// ==============================================================
template <uint32_t B>
inline void accumulate(uint32_t nblk, const uint8_t *codes, const uint8_t *LUT,
                       uint16_t *result) {
...
// ==============================================================
template <uint32_t B> inline void pack_LUT(uint8_t *byte_query, uint8_t *LUT) {
  constexpr uint32_t M = B / 4;
...
inline void get_matrix_column(T *src, size_t m, size_t n, int64_t i, int64_t j,
                              TA &dest) {
...
void pack_codes(const uint64_t *binary_code, uint32_t ncode, uint8_t *blocks) {
  ...
  for (int i = 0; i < ncode; i++)
    for (int j = 0; j < B / 64; j++)
      for (int k = 0; k < 4; k++)
        swap(binary_code_8bit[i * B / 8 + 8 * j + k],
