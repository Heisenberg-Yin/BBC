...
def main():
    ...
    parser.add_argument("--dataset", default="deep100m", help="dataset name")
    parser.add_argument("--source", default="./", help="root data directory")
    parser.add_argument(
        "--batch", type=int, default=200_000, help="batch size when assigning vectors"
    )
    parser.add_argument(
        "--sample", type=int, default=10_000_000, help="training sample size"
    )
    parser.add_argument(
        "--niter", type=int, default=25, help="k‑means iters for OPQ rotation"
    )
    parser.add_argument("--out", default="../OPQ/data/", help="root data directory")
    parser.add_argument(
    ...
    centroid_f = os.path.join(
        "/mnt/hdd/yinziqi/yinziqi/large-heap/src/data/",
        args.dataset,
        "centroid_4096.fvecs",
    )
    base_f = os.path.join(
        "/mnt/hdd/yinziqi/yinziqi/large-heap/src/data/", args.dataset, "base.fvecs"
    )
